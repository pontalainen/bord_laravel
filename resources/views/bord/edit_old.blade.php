    ...
    <div class="w-4/5 mx-auto">
        ...
        <div class="m-auto pt-20">
            ...
            <div class="py-10 px-5 absolute top-2 left-2">
                <a class="primary-btn inline text-base sm:text-xl bg-blue-400 py-4 px-4 shadow-xl rounded-full transition-all hover:bg-blue-300 font-normal" href="{{ route('bord.index') }}">
                    Go back
                </a>
            </div>
            ...
            <form action="{{ route('bord.update', $page->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" name="name" placeholder="Name..." class="bg-white block rounded-lg w-full h-20 text-2xl outline-none border-none m-4 drop-shadow-xl">

                <textarea name="content" placeholder="Content..." class="py-20 bg-white block rounded-lg w-full h-60 text-xl outline-none border-none m-4 drop-shadow-xl"></textarea>

                <div class="bg-grey-lighter py-10">
                    <label class="w-44 flex flex-col items-center px-2 py-3 bg-white rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer m-4">
